...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        // 默认箭头指向中间
        self.arrowPosition = TWPopMenuArrowPositionCenter;
    }
    return self;
}
...
- (void)setArrowPosition:(TWPopMenuArrowPosition)arrowPosition
{
    _arrowPosition = arrowPosition;
    
    switch (arrowPosition) {
        case TWPopMenuArrowPositionCenter:
            self.container.image = [UIImage resizedImage:@"popover_background"];
            break;
            
        case TWPopMenuArrowPositionLeft:
            self.container.image = [UIImage resizedImage:@"popover_background_left"];
            break;
            
        case TWPopMenuArrowPositionRight:
